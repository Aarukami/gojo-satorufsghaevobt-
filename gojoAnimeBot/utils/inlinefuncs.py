...
from gojoAnimeBot.extrastuff import SUDOERS
from gojoAnimeBot import LOG_GROUP_ID
from gojoAnimeBot import pgram as app 
from gojoAnimeBot.arqclient import arq
from gojoAnimeBot.utils.keyboard import ikb
from gojoAnimeBot.core.tasks import _get_tasks_text, all_tasks, rm_task
from gojoAnimeBot.core.types import InlineQueryResultCachedDocument
from gojoAnimeBot.modules.info import get_chat_info, get_user_info
from gojoAnimeBot.modules.music import download_youtube_audio
from gojoAnimeBot.utils.functions import test_speedtest
from gojoAnimeBot.utils.pastebin import paste
...
"""
    answers.append(
        InlineQueryResultArticle(
            title="Alive",
            description="Check gojo's Stats",
