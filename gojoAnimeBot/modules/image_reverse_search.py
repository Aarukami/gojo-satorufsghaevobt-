...
def reverse(update: Update, context:CallbackContext):
    ...
    try:
        ...
        if response != 400:
            xx = bot.send_message(chat_id, "Image was successfully uploaded from Google meow."
        ...
        if guess and imgspage:
            xx.edit_text(f"[{guess}]({fetchUrl})\nRerversing On Google meow...", parse_mode='Markdown', disable_web_page_preview=True)
        else:
