...
import gojoAnimeBot.modules.sql.notes_sql as sql
from gojoAnimeBot import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from gojoAnimeBot.__main__ import DATA_IMPORT
from gojoAnimeBot.modules.helper_funcs.chat_status import user_admin
from gojoAnimeBot.modules.helper_funcs.alternate import typing_action

# from gojoAnimeBot.modules.rules import get_rules
import gojoAnimeBot.modules.sql.rules_sql as rulessql

# from gojoAnimeBot.modules.sql import warns_sql as warnssql
import gojoAnimeBot.modules.sql.blacklist_sql as blacklistsql
from gojoAnimeBot.modules.sql import disable_sql as disabledsql

# from gojoAnimeBot.modules.sql import cust_filters_sql as filtersql
# import gojoAnimeBot.modules.sql.welcome_sql as welcsql
import gojoAnimeBot.modules.sql.locks_sql as locksql
from gojoAnimeBot.modules.connection import connected
...
def export_data(update, context):
    ...
    with open("gojo{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("gojo{}.backup".format(chat_id), "rb"),
    ...
    os.remove("gojo{}.backup".format(chat_id))  # Cleaning file
...
*Only for group owner:*
 ...
 • `/import`: Reply to the backup file for the butler / gojo group to import as much as possible, making transfers very easy! \
