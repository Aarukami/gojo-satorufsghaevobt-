...
from gojoAnimeBot import (DEL_CMDS, DEV_USERS, DRAGONS, SUPPORT_CHAT, DEMONS,
...
def bot_admin(func):
    ...
    def is_admin(update: Update, context: CallbackContext, *args, **kwargs):
        ...
        if update_chat_title == message_chat_title:
            not_admin = "meow meow I'm not admin! promote me khi khi khi"
        else:
...
def bot_can_delete(func):
    ...
    def delete_rights(update: Update, context: CallbackContext, *args,
        ...
        if update_chat_title == message_chat_title:
            cant_delete = "meow I can't delete messages here!\nMake sure I'm admin and can delete other user's messages."
        else:
            cant_delete = f"meow I can't delete messages in <b>{update_chat_title}</b>!\nMake sure I'm admin and can delete other user's messages there."
...
from gojoAnimeBot.modules import connection
