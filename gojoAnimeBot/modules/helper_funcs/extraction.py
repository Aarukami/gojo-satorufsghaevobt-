...
from gojoAnimeBot import LOGGER
...
def extract_unt_fedban(message: Message,
    ...
    try:
        ...
        if excp.message in ("User_id_invalid",
            ...
            message.reply_text(
                "meow meow I don't seem to have interacted with this user before "
                "meow please forward a message from them to give me control! "
