...
EMILIA_IMG = "https://telegra.ph/file/baa079097a3b8a91c09ab.jpg"
...
buttons = [
    ...
    [
        InlineKeyboardButton(
          text="📮 Updates", url="https://t.me/mhaprvt"
        ),
    ...
    [
       InlineKeyboardButton(
           text="🐱 Support", url="https://t.me/gojosatorusupport"
         ),
    ],
    [
        InlineKeyboardButton(
    ...
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_photo(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                  [
                  InlineKeyboardButton(text="Sᴜᴘᴘᴏʀᴛ", url="https://telegram.dog/gojosatorusupport")
                  ],
                  [
