...
from gojoAnimeBot import MONGO_DB_URI
from gojoAnimeBot import telethn
...
def load_module(shortname):
    if shortname.startswith("__"):
        ...
        import importlib
        import gojoAnimeBot.tevents

        path = Path(f"gojoAnimeBot/modules/{shortname}.py")
        name = "gojoAnimeBot.modules.{}".format(shortname)
