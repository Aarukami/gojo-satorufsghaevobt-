...
if ENV:
    ...
    from gojoAnimeBot.config import Development as Config
    TOKEN = Config.TOKEN
...
from gojoAnimeBot.modules.helper_funcs.handlers import (CustomCommandHandler,
