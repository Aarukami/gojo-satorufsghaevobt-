...
from kurama9tAnimeBot import (DEV_USERS, OWNER_ID, DRAGONS, DEMONS, TIGERS, WOLVES,
                          INFOPIC, dispatcher, sw)
from kurama9tAnimeBot.__main__ import STATS, TOKEN, USER_INFO
import kurama9tAnimeBot.modules.sql.userinfo_sql as sql
from kurama9tAnimeBot.modules.disable import DisableAbleCommandHandler
from kurama9tAnimeBot.modules.sql.global_bans_sql import is_user_gbanned
from kurama9tAnimeBot.modules.sql.afk_sql import is_afk, check_afk_status
from kurama9tAnimeBot.modules.sql.users_sql import get_user_num_chats
from kurama9tAnimeBot.modules.helper_funcs.chat_status import sudo_plus
from kurama9tAnimeBot.modules.helper_funcs.extraction import extract_user
from kurama9tAnimeBot import telethn as kurama9tTelethonClient
...
def info(update: Update, context: CallbackContext):
    ...
    if user.id == OWNER_ID:
        ...
        text += "\n\nThis meow is a Sudo-User of kurama9t"
        disaster_level_present = True
    elif user.id in DEMONS:
        text += "\n\nThis meow is a Support User of kurama9t"
        disaster_level_present = True
    elif user.id in TIGERS:
        text += "\n\nThis meow is Immune to all Restrictions over kurama9t"
        disaster_level_present = True
    elif user.id in WOLVES:
        text += "\n\nThis meow is Immune to Automated Restrictions"
        disaster_level_present = True
