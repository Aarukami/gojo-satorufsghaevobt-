...
from kurama9tAnimeBot.extrastuff import SUDOERS
from kurama9tAnimeBot import LOG_GROUP_ID
from kurama9tAnimeBot import pgram as app 
from kurama9tAnimeBot.arqclient import arq
from kurama9tAnimeBot.utils.keyboard import ikb
from kurama9tAnimeBot.core.tasks import _get_tasks_text, all_tasks, rm_task
from kurama9tAnimeBot.core.types import InlineQueryResultCachedDocument
from kurama9tAnimeBot.modules.info import get_chat_info, get_user_info
from kurama9tAnimeBot.modules.music import download_youtube_audio
from kurama9tAnimeBot.utils.functions import test_speedtest
from kurama9tAnimeBot.utils.pastebin import paste
...
async def alive_function(answers):
    ...
    msg = f"""
**[gojo✨](https://github.com/Aarukami/gojo-satoru):**
**RoBot:** `{bot_state}`
...
"""
    answers.append(
        InlineQueryResultArticle(
            title="Alive",
            description="Check gojos Stats",
            thumb_url="(aaru gojo photo)",
            input_message_content=InputTextMessageContent(
