...
if ENV:
    ...
    from kurama9tAnimeBot.config import Development as Config
    TOKEN = Config.TOKEN
...
telethn = TelegramClient("kurama9t", API_ID, API_HASH)
pgram = Client("EmiPyro", api_id=API_ID, api_hash=API_HASH, bot_token=TOKEN)
mongo_client = MongoClient(MONGO_DB_URI)
db = mongo_client.kurama9tAnimeBot
...
from kurama9tAnimeBot.modules.helper_funcs.handlers import (CustomCommandHandler,
...
end_credits = """
INFO GATHERED!
Client: kurama9t Pyro
Copyright: (c) 2021 kurama9tAnimeBot
"""
print(end_credits)
