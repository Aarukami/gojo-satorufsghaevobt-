...
from kurama9tAnimeBot import TIGERS, WOLVES, dispatcher
...
from kurama9tAnimeBot.modules.sql import antiflood_sql as sql
...
def set_flood(update, context) -> str:
    ...
    if conn:
        ...
        if update.effective_message.chat.type == "private":
            send_message(update.effective_message,
                         "This command is meant to use in group not in PM oke doke!")
            return ""
