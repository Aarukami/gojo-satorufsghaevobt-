...
from kurama9tAnimeBot import MONGO_DB_URI
from kurama9tAnimeBot import telethn

client = MongoClient()
client = MongoClient(MONGO_DB_URI)
db = client["kurama9tanimebot"]
gbanned = db.gban
...
def load_module(shortname):
    if shortname.startswith("__"):
        ...
        import importlib
        import kurama9tAnimeBot.tevents

        path = Path(f"kurama9tAnimeBot/modules/{shortname}.py")
        name = "kurama9tAnimeBot.modules.{}".format(shortname)
        ...
        spec.loader.exec_module(mod)
        sys.modules["Jarvis.modules." + shortname] = mod
        print("Successfully imported " + shortname)


path = "kurama9tAnimeBot/modules/*.py"
