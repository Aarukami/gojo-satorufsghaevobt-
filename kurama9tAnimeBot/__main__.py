...
from kurama9tAnimeBot import (ALLOW_EXCL, CERT_PATH, DONATION_LINK, LOGGER,
                          OWNER_ID, PORT, SUPPORT_CHAT, TOKEN, URL, WEBHOOK,
                          dispatcher, StartTime, telethn, updater, pgram)

from kurama9tAnimeBot.modules import ALL_MODULES
from kurama9tAnimeBot.modules.helper_funcs.chat_status import is_user_admin
from kurama9tAnimeBot.modules.helper_funcs.misc import paginate_modules
...
KURAMA9T_IMG = "https://telegra.ph/file/827408b63c867a13d4d94.jpg"

KURAMA9T_USAGE_TEXT = """
Basic Usage Help For Gojo
...
PM_START_TEXT = """
This is Gojo[.](https://telegra.ph/file/baa079097a3b8a91c09ab.jpg)
...
buttons = [
    [
        InlineKeyboardButton(
            text="🏹Summon ME🏹",url="t.me/I_Am_Strongest_bot?startgroup=true"
        ),
    ],
    [
        InlineKeyboardButton(
    ...
    [
        InlineKeyboardButton(
          text="📮 Updates", url="t.me/domain_infinity_void"
        ),
    ...
    [
       InlineKeyboardButton(
           text="🐱 Support", url="https://t.me/domain_infinity_void"
         ),
    ],
    [
        InlineKeyboardButton(
...
HELP_STRINGS = """
Hey there! My name is [Gojo!](https://telegra.ph/file/baa079097a3b8a91c09ab.jpg) 
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("kurama9tAnimeBot.modules." + module_name)
...
def start(update: Update, context: CallbackContext):
    ...
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_photo(
            KURAMA9T_IMG, caption= "<code>Gojo is Here For You❤️\nI am Awake Since</code>: <code>{}</code>".format(
                uptime
            ),
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                  [
                  InlineKeyboardButton(text="Sᴜᴘᴘᴏʀᴛ", url="https://t.dog/domain_infinity_void")
                  ],
                  [
                  InlineKeyboardButton(text="Sᴏᴜʀᴄᴇ", url="https://github.com/Aarukami/gojo-satoru")
                  ]
                ]
            ),
        )
...
def Basic_usage_callback(update, context):
  ...
  if query.data == "usage_":
    query.message.edit_text(
      text = KURAMA9T_USAGE_TEXT,
      parse_mode = ParseMode.MARKDOWN,
      disable_web_page_preview = True,
      reply_markup = InlineKeyboardMarkup(
        [
          [
            InlineKeyboardButton(text="Go Back", callback_data="kurama9t_back")
          ]
        ]
      ),
    )
  elif query.data == "kurama9t_back":
       query.message.edit_text(
               PM_START_TEXT,
               reply_markup=InlineKeyboardMarkup(buttons),
               parse_mode=ParseMode.MARKDOWN,
...
def Source_about_callback(update, context):
    ...
    if query.data == "source_":
        query.message.edit_text(
            text=""" hi i am gojo*
                 \nMy Source Code Can be Found at Github at this [Link](https://github.com/Aarukami/gojo-satoru""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
    ...
    if chat.type != chat.PRIVATE:
        ...
        send_help(
            ...
            InlineKeyboardMarkup(
                [[InlineKeyboardButton(text="Back", callback_data="help_back"),
                                InlineKeyboardButton(
                                    text="Support", url="https://telegram.dog/domain_infinity_void"
                                )]]
            ),
        )
...
def donate(update: Update, context: CallbackContext):
    ...
    if chat.type == "private":
        ...
        if OWNER_ID != 1937862080 and DONATION_LINK:
            update.effective_message.reply_text(
...
if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@{SUPPORT_CHAT}", "Gojo is Back Online💼")
        except Unauthorized:
            LOGGER.warning(
