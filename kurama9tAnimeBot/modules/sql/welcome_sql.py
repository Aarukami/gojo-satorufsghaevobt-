...
from kurama9tAnimeBot.modules.helper_funcs.msg_types import Types
from kurama9tAnimeBot.modules.sql import BASE, SESSION
from sqlalchemy import (BigInteger, Boolean, Column, Integer, String,
                        UnicodeText)

DEFAULT_WELCOME = 'Hey {first}, how are you nice to meet ya i hope u will stay with us cutie'
DEFAULT_GOODBYE = 'why did you leave shoud i die now'
...
DEFAULT_GOODBYE_MESSAGES = [
    "{first} whyy did you leave °~°",
    "{first} imma start crying now",
    "{first} nooo please don't go",
