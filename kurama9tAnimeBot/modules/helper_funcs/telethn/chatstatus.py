from kurama9tAnimeBot.modules.helper_funcs.telethn import IMMUNE_USERS, telethn
from kurama9tAnimeBot import DRAGONS
...
async def kurama9t_is_admin(chat_id: int):
    status = False
