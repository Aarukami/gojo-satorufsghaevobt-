...
def totranslate(update: Update, context: CallbackContext):
    ...
    try:
        ...
        update.effective_message.reply_text(
            "meow Reply to messages or write messages from other languages ​​for translating into the intended language\n\n"
        ...
        update.effective_message.reply_text("meow The intended language is not found!")
    else:
        return
